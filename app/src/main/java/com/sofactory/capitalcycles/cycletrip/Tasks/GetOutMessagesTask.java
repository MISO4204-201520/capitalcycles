 ...
 */
public class GetOutMessagesTask extends AsyncTask<Void,Void,RespuestaMensajeDTO> {
    ...
    public GetOutMessagesTask(Context context,String idUser) {
    ...
    protected RespuestaMensajeDTO doInBackground(Void... params) {
        ...
        String serviceUri = context.getResources().getString(R.string.serviceGetOutMessagesURI);
