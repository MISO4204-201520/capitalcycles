 ...
 */
public class UpdateUserTask  extends AsyncTask<Void, Void, RespuestaUsuarioDTO> {
    ...
    public UpdateUserTask(UsuarioDTO usuarioDTO, Context context,GenericProgress genericProgress) {
    ...
    protected RespuestaUsuarioDTO doInBackground(Void... params) {
        ...
        String serviceUri = context.getResources().getString(R.string.serviceUpdateUserURI);
        RespuestaUsuarioDTO response = null;
        try {
            HttpPut httpPut = new HttpPut(serverIp.concat(serviceUri));
    ...
    protected void onPostExecute(final RespuestaUsuarioDTO response) {
        ...
        if(response.getCodigo()==0){
            ...
            Toast toast = Toast.makeText(context, R.string.update_user_success, Toast.LENGTH_LONG);
            ...
            Toast toast = Toast.makeText(context, R.string.update_user_error, Toast.LENGTH_LONG);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
