 ...
 */
public class GetProductsTask extends AsyncTask<Void,Void,CatalogoDTO> {
    ...
    public GetProductsTask(Context context, String idUser) {
    ...
    @Override
    protected CatalogoDTO doInBackground(Void... params) {

        String serverIp = context.getResources().getString(R.string.serverIp);
        String serviceUri = context.getResources().getString(R.string.serviceGetProductsURI);
        String paramsGet = "/" + idUser;
        CatalogoDTO response = null;
        try {
            ...
            response = new GsonBuilder().create().fromJson(json, CatalogoDTO.class);
            return response;
